...
class AbakkusTermsAndConditions extends Component {
	render() {
		return (
			<div>
				<Helmet>
					<title>Abakkus Terms and Conditions</title>
				</Helmet>
				<AbakkusNavbar />
				<div>
					<Section>
						<Container style={{ marginLeft: "32px", marginRight: "32px" }}>
							...
							<br />
							<span> ABAKKUS ASSET MANAGER LLC</span> is located at:
							<br />
							<address>
								1st Floor, 106, B-Wing, G Block, The Capital, Bandra Kurla
							...
							<p>
								...
								conditions in full. Do not continue to use Abakkus Asset Manager
								LLP's website if you do not accept all of the terms and
							...
							<p>
								We employ the use of cookies. By using Abakkus Asset Manager
								LLP's website you consent to the use of cookies in accordance
								with Abakkus Asset Manager LLP’s privacy policy.
							</p>
							<br />
							<p>
							...
							<p>
								...
								on Abakkus Asset Manager LLP. All intellectual property rights
								are reserved. You may view and/or print pages from
								http://www.abakkusinvest.com for your own personal use subject
							...
							<br />
							<ol>
								<li>Republish material from http://www.abakkusinvest.com</li>
								<li>
									Sell, rent or sub-license material from
									http://www.abakkusinvest.com
								</li>
								<li>
							...
							<p>
								Redistribute content from Abakkus Asset Manager LLP (unless
							...
							<p>
								...
								of Abakkus; and (d) where the link is in the context of general
							...
							<p>
								...
								<a
									href="mailto:info@abakkusinvest.com"
									title="send an email to info@abakkusinvest.com"
								>
									info@abakkusinvest.com
								</a>
							...
							<p>
								No use of Abakkus Asset Manager LLP’s logo or other artwork will
							...
							<p>
								...
								<a href="#footer">please contact us.</a>
							</p>
							<br />
						</Container>
					</Section>
...
export default AbakkusTermsAndConditions;
