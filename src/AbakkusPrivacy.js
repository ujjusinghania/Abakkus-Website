...
class AbakkusPrivacy extends Component {
	render() {
		return (
			<div>
				<Helmet>
					<title>Abakkus Privacy Policy</title>
				</Helmet>
				<AbakkusNavbar />
				<div>
					<Section>
						<Container style={{ marginLeft: "32px", marginRight: "32px" }}>
							<Heading>Abakkus Asset Manager LLP's Privacy Policy</Heading>
							<p>
							...
							<br />
							<Heading subtitle>When do we collect information?</Heading>
							...
							<br />
							<Heading subtitle>How do we use your information?</Heading>
							<p>
							...
							<br />
							<Heading subtitle>How do we protect your information?</Heading>
							<ol>
								<li>
							...
							<br />
							<Heading subtitle>Do we use 'cookies'?</Heading>
							...
							<br />
							<Heading subtitle>Third-party disclosure</Heading>
							...
							<br />
							<Heading subtitle>Third-party links</Heading>
							...
							<br />
							<Heading subtitle>Google</Heading>
							...
							<br />
							<Heading subtitle>Fair Information Practices</Heading>
							...
							<br />
							<Heading subtitle>CAN SPAM Act</Heading>
							...
							<p>
								...
								future emails, you can email us at media@abakkusinvest.com or
							...
							<br />
							<Heading subtitle>Contacting Us</Heading>
