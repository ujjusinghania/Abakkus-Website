...
import { Section, Heading, Container, Table } from "react-bulma-components";
	...
	render() {
		return (
			<div>
				<AbakkusNavbar />
				<Helmet>
					<title>Abakkus Investment Philosophy</title>
				</Helmet>
				<div>
				<Section>
						<Container fluid style={{ marginRight: "32px", marginBottom: "48px" }}>
							<Heading>Offerings</Heading>
							<p>
							Abakkus is an alpha focused boutique asset manager managing long only equity strategies in India:
							</p>
							<li>Close ended Category III Alternative Investment Funds</li>
							<li>Portfolio Management Services</li>
							<li>Advisory Services for Domestic and International Investors</li>
							<p>Ambition and vision is to make Abakkus, one of India's most revered and top performing asset managers over time.</p>
						</Container>
						<Container fluid style={{ marginRight: "32px", marginBottom: "48px" }}>
							<Heading>Investment Philosophy</Heading>
							<p>
								Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin
								vulputate eros sed ante suscipit feugiat. Mauris vehicula,
								libero eu consectetur sollicitudin, est diam fringilla neque,
								sed tincidunt libero ex id dolor. Vestibulum scelerisque urna
								elit, vel fringilla arcu vehicula eget. Ut ipsum justo,
								consequat at velit et, ornare sollicitudin turpis. Aenean
								euismod leo velit, in luctus magna consequat in. Suspendisse
								potenti. Suspendisse nisl risus, gravida at magna et, facilisis
								maximus ante. Duis eget purus a erat facilisis commodo in
								convallis ante. Duis suscipit, sapien ac ullamcorper elementum,
								nulla sem malesuada metus, posuere pretium purus urna sed justo.
								Proin ex ipsum.
							</p>
						</Container>
						<Container fluid style={{ marginRight: "32px", marginBottom: "48px" }}>
						...
						<Container fluid style={{ marginRight: "32px", marginBottom: "48px" }}>
							...
							<Accordion>
								<AccordionSummary
									...
									id="additional-actions1-header"
								>
									<Heading subtitle>Near to medium term uptrend in smaller sectors</Heading>
								</AccordionSummary>
